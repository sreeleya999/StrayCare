...
class Lolog extends StatefulWidget {
  const Lolog({Key? key}) : super(key: key);

  @override
  State<Lolog> createState() => _LologState();
}

class _LologState extends State<Lolog> {
  ...
  Future<void> getData() async {
    ...
    var response = await post(Uri.parse('${Con.url}lologin.php'), body: data);
    print(response.body);
