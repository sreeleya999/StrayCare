...
class Lohom extends StatefulWidget {
  const Lohom({Key? key}) : super(key: key);

  @override
  State<Lohom> createState() => _LohomState();
}

class _LohomState extends State<Lohom> {
  ...
  Future<void> sendData()async {
    ...
    var response = await post(Uri.parse('${Con.url}local.php'), body: data);
    print(response.body);
