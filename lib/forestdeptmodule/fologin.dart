...
class Folog extends StatefulWidget {
  const Folog({Key? key}) : super(key: key);

  @override
  State<Folog> createState() => _FologState();
}

class _FologState extends State<Folog> {
  ...
  Future<void> getData() async {
    ...
    var response = await post(Uri.parse('${Con.url}fologin.php'), body: data);
    print(response.body);
