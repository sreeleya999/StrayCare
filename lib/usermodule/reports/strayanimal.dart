...
import '../../connect.dart';
class Stray extends StatefulWidget {
  Stray({Key? key,required this.id}) : super(key: key);
  var id;

  @override
  State<Stray> createState() => _StrayState();
}

class _StrayState extends State<Stray> {
