...
class Agre extends StatefulWidget {

  Agre({Key? key,required this.id}) : super(key: key);
  var id;
  @override
  State<Agre> createState() => _AgreState();
}

class _AgreState extends State<Agre> {
  var description=TextEditingController();

  Future<void> sendData()async {
    var data = {
      "description": description.text,
      "report_type":'Agressive Animal',
      "id": widget.id,
