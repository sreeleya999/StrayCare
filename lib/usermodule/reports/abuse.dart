...
class Abu extends StatefulWidget {
  Abu({Key? key,required this.id}) : super(key: key);
  var id;

  @override
  State<Abu> createState() => _AbuState();
}

class _AbuState extends State<Abu> {
  var description=TextEditingController();

  Future<void> sendData()async {
    var data = {
      "description": description.text,
      "report_type":'Abuse Towards Animals',
      "id": widget.id,
