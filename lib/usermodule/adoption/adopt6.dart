...
class Adopt6 extends StatefulWidget {
  const Adopt6({Key? key}) : super(key: key);

  @override
  State<Adopt6> createState() => _Adopt6State();
}

class _Adopt6State extends State<Adopt6> {
  @override
        ...
        body:Center(
            child: Column(
                children: [
                  ...
                  Text("Ragdoll",style: TextStyle(color: Colors.black, fontSize: 20,fontFamily: 'railway',fontWeight: FontWeight.bold),
                  ),
                  Column(
                      ...
                      children:[
                        ...
                        Text("Breed : Ragdoll",style: TextStyle(color: Colors.black, fontSize: 12,fontFamily: 'railway',fontWeight: FontWeight.bold),
                        ),
                        SizedBox(
                          height: 10,
                        ),
