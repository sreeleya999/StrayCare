...
class Adopt3 extends StatefulWidget {
  const Adopt3({Key? key}) : super(key: key);

  @override
  State<Adopt3> createState() => _Adopt3State();
}

class _Adopt3State extends State<Adopt3> {
  @override
        ...
        body:Center(
            child: Column(
                children: [
                  ...
                  Text("Labrador",style: TextStyle(color: Colors.black, fontSize: 20,fontFamily: 'railway',fontWeight: FontWeight.bold),
                  ),
                  Column(
