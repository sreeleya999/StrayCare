...
class Vohom extends StatefulWidget {
  const Vohom({Key? key}) : super(key: key);

  @override
  State<Vohom> createState() => _VohomState();
}

class _VohomState extends State<Vohom> {
  ...
  Future<void> sendData()async {
    ...
    var response = await post(Uri.parse('${Con.url}veterinary.php'), body: data);
    print(response.body);
            ...
            child: SingleChildScrollView(
                child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed:(){
                          Uri launchUri = Uri(scheme: 'tel', path: '9894560041');
                          launchUrl(launchUri);
                        },
                        style: ElevatedButton.styleFrom(
                            backgroundColor: Colors.red.shade300,
                            ...
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(50))),
                        child: const Text('Call Stray care'),
                      ),
                      SizedBox(
                        height: 20,
                      ),
