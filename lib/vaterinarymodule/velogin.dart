...
import 'package:straycare/vaterinarymodule/vehome.dart';

import '../connect.dart';


class Volog extends StatefulWidget {
  const Volog({Key? key}) : super(key: key);

  @override
  State<Volog> createState() => _VologState();
}

class _VologState extends State<Volog> {
  ...
  Future<void> getData() async {
    ...
    var response = await post(Uri.parse('${Con.url}vetilogin.php'), body: data);
    print(response.body);
