...
class Pohom extends StatefulWidget {
  const Pohom({Key? key}) : super(key: key);

  @override
  State<Pohom> createState() => _PohomState();
}

class _PohomState extends State<Pohom> {
  ...
  Future<void> sendData()async {
    ...
    var response = await post(Uri.parse('${Con.url}police.php'), body: data);
    print(response.body);
