...
if(isset($_POST['submit'])){
  ...
  $eno = $_POST['etno'];
  mysqli_query($con,"INSERT INTO veterinarylogin(name,password,email,phone_no,clinic,location)values('$dno','$wno','$mno','$yno','$cn','$eno')");
...
<div class="card">
  ...
  <br>
    ...
    <form class="row g-2" method="post">
      ...
      <div class="row mb-3">
      <label for="inputEmail4" class="form-label">Clinic</label>
        <input type="text" name="cli" class="form-control" id="inputEmail4">
      </div>
      <div class="row mb-3">
