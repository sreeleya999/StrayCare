...
if(isset($_POST['submit'])){
  ...
  mysqli_query($con,"INSERT INTO policelogin(name,password,station,phone_no)values('$dno','$wno','$mno','$yno')");
...
<div class="card">
  <div class="card-body">
  <br>
    <a href="viewschedule.php" class="btn btn-primary">ADD</a>
    ...
    <form class="row g-2" method="post">
      ...
      <div class="row mb-3">
      <label for="inputEmail4" class="form-label">Station</label>
